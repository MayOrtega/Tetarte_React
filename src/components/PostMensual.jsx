...
const PostMensual = () => {
  return (
    ...
    <div className='encabezado-blog'>
      <h1 className='texto-blog-tetarte-h1'>LACTANCIA PROLONGADA - Agosto 2022</h1>
...
Hace 10 años comenzamos un camino, sembramos una semilla llena de amor lácteo que hoy vemos en aquellas familias que hacen de la lactancia una instancia de transmisión de amor y sabiduría. 
El acceso a la información, la visibilización de la lactancia materna y la confianza en nuestros cuerpos es parte del futuro que hoy comenzamos a ver. 
</h3>
    </div>
    </>
