    ...
    <div className="title-sesiones-principal">
      ...
      <div className="content-pictures">
        ...
        <section className="section-pic">
          ...
          <Link to="../views/Santiago.jsx" className="links-nav" target="_blank" rel="noreferrer">
            <img src={album1} className="pictures" alt=""></img>
          </Link>
        </section>
        <section className="section-pic">
          <h3 className="title-pic">Castro</h3>
          <Link to="../views/Castro.jsx" className="links-nav" target="_blank" rel="noreferrer">
            <img src={album2} className="pictures" alt=""></img>
          </Link>
        </section>
        <section className="section-pic">
          <h3 className="title-pic">Temuco</h3>
          <Link to="../views/Temuco.jsx" className="links-nav" target="_blank" rel="noreferrer">
            <img src={album3} className="pictures" alt=""></img>
          </Link>
        </section>
        <section className="section-pic">
          <h3 className="title-pic">San Antonio</h3>
          <Link to="../views/SanAntonio.jsx" className="links-nav" target="_blank" rel="noreferrer">
            <img src={album4} className="pictures" alt=""></img>
          </Link>
        </section>
         <section className="section-pic">
          <h3 className="title-pic">Curicó</h3>
          <Link to="../views/Curico.jsx" className="links-nav" target="_blank" rel="noreferrer">
            <img src={album5} className="pictures" alt=""></img>
          </Link>
          </section>
          <section className="section-pic">
          <h3 className="title-pic">Pichilemu</h3>
          <Link to="../views/Pichilemu.jsx" className="links-nav" target="_blank" rel="noreferrer">
            <img src={album6} className="pictures" alt=""></img>
          </Link>
        </section>
        <section className="section-pic">
          <h3 className="title-pic">Rancagua</h3>
          <Link to="../views/Rancagua.jsx" className="links-nav" target="_blank" rel="noreferrer">
            <img src={album7} className="pictures" alt=""></img>
          </Link>
        </section>
        <section className="section-pic">
          <h3 className="title-pic">Valparaíso</h3>
          <Link to="../views/Valparaiso.jsx" className="links-nav" target="_blank" rel="noreferrer">
            <img src={album8} className="pictures" alt=""></img>
          </Link>
        </section>
        <section className="section-pic">
          <h3 className="title-pic" id="pics-bucaramanga">Bucaramanga - Colombia</h3>
          <Link to="../views/Bucaramanga.jsx" className="links-nav" target="_blank" rel="noreferrer">
